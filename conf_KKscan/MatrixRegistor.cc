...
int main(int argc,const char*argv[]){
  ...
  int runnum[5] = {74808,74845,74855,75002,75036};
  int mag;
  mag = atoi(argv[1]);
  ...
  for(int i=1; i<7; ++i){
    ...
    snprintf(iQmConfname, 100, "%s%d%s%d%s", "analyzer_e70_", runnum[j],"_Qm00",i, ".conf");
    snprintf(iQpConfname, 100, "%s%d%s%d%s", "analyzer_e70_", runnum[j],"_Qp00",i, ".conf");
